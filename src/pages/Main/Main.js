                ...
                <div className="container">
                    ...
                    <div className="stack">
                        <ul>
                            ...
                            <li className="button p-10">Responsive markup</li>
                    ...
                    <p>
                        ...
                        <b>POST</b>data, parse server response to laravel.blade
                        view file by filling/generating text fields or fill the
                        dataTable with data. Also i have wrote some
                        ...
                        predefined data,<b>taskboard</b>(like meistertask). Also
                        i was fixing bugs, resurrecting legacy code.
                    </p>
                    <p>
                        Also i have developed <b>Browser Extension</b> for fast
                        log in/out and clock in/out.
                    </p>
                    <p>
                        One of my talents is handling problems, finding crazy
                        workarounds or surfing "Stack Overflow" <b>;&#41;</b>
                    </p>
                </div>
            </section>
            {data && data.length !== 0 ? (
